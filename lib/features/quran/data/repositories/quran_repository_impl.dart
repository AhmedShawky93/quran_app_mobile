...
class QuranRepositoryImpl implements QuranRepository {
  ...
  Future<String> addBookmark(
    ...
    try {
      final bookmarkId = await remoteDataSource.addBookmark(
        userId,
        verseId,
      );
  ...
  Future<List<Bookmark>> getBookmarks(String userId) async {
    try {
      ...
      throw Exception(
        'Failed to fetch bookmarks and no local cache available: $e',
      );
    }
  }
  ...
  Future<void> saveReadingProgress(
    ...
    try {
      ...
      final readingProgress = ReadingProgressModel(
        userId: userId,
        lastSurahId: surahId,
        lastVerseId: verseId,
      ...
      await localDataSource.cacheReadingProgress(
        userId,
        readingProgress,
      );
    } catch (e) {
